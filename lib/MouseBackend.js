  ...
  _createClass(MouseBackend, [{
    ...
    value: function sortTargetIds(matchingTargetIds) {
      ...
      matchingTargetIds.sort(function (id1, id2) {
        ...
        return between(br2.x, br1.x, br1.width) && between(br2.x + br2.width, br1.x, br1.width) && between(br2.y, br1.y, br1.height) && between(br2.y + br2.height, br1.y, br1.height) ? -1 : 1;
      });
    }
  }, {
